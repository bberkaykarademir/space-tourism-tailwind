...
const Crew = () => {
  return (
    <div className=" bg-[url(/public/assets/crew/background-crew-tablet.jpg/)] md:bg-[url(/public/assets/crew/background-crew-desktop.jpg/)] bg-cover bg-no-repeat bg-center md:h-screen w-full text-white  lg:p-14">
      <Header />
