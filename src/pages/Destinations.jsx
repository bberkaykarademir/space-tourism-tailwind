...
const Destinations = () => {
  ...
  return (
    <div className=" overflow-hidden bg-[url(/public/assets/destination/background-destination-tablet.jpg/)] md:bg-[url(/public/assets/destination/background-destination-desktop.jpg/)] bg-cover bg-no-repeat bg-center min-h-screen sm:h-screen w-full text-white  lg:p-14">
      <Header />
